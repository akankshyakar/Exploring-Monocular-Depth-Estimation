...
class OrdinalRegressionLayer(nn.Module):
    def __init__(self, args):
        ...
        self.beta = args.beta_ord
        self.gamma = args.gamma_ord
        self.ord_num = args.ord_num
    ...
    def forward(self, x):
        ...
        t0 = 1.0 + (self.beta - 1.0) * ord_label.float() / self.ord_num
        t1 = 1.0 + (self.beta - 1.0) * (ord_label.float() + 1) / self.ord_num
        disp = (t0 + t1) / 2 - self.gamma
